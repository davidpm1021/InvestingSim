...
export const WALKTHROUGH_STEPS: WalkthroughStep[] = [
  ...
  },
  {
    ...
    body: [
      'In this simulation, your savings account and your cash settlement account pay different interest rates. You move money into your cash settlement account to buy investments, which can rise or fall in value but have more room to grow than money sitting in a bank account.',
    ],
    ...
    questions: [
      {
        ...
        explanation: 'In this simulation, your cash settlement account earns less than savings, so moving money over is about investing, not interest. Investing can grow faster than cash over time, though it can also lose value. Some cash settlement accounts pay more than a basic savings account and some pay less, so it is worth checking the actual rates.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      'Both your savings and your cash settlement account earn interest each month. Your investments can also pay dividends or bond income each quarter. A dividend can even arrive while a price falls.',
    ],
