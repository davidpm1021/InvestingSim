    ...
    questions: [
      {
        ...
        explanation: 'In this simulation, your cash settlement account earns less than savings, so moving money over is about investing, not interest. Investing can grow faster than cash over time, though it can also lose value. In real life, some cash settlement accounts pay more than a basic savings account and some pay less, so it is worth checking the actual rates.',
      },
    ],
  },
  {
