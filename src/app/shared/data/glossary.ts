...
export const GLOSSARY: { [term: string]: string } = {
  ...
  'Cash Settlement Account': 'The cash in your brokerage waiting to be invested or withdrawn. It earns a small yield.',
  'Cash Available': "Cash in your brokerage that isn't invested — ready to buy investments or to withdraw.",
  'Settlement': 'The short delay before a trade is final and the cash is available — usually the next business day (T+1).',
  'Transfer': 'Moving money between accounts — for example, from your bank to your brokerage to fund investing.',
  ...
  'Investments': "The current value of everything you own in the brokerage (stocks, funds, bonds) — not counting cash.",
  ...
  'Commission-free': 'No fee to buy or sell. Most brokerages no longer charge a per-trade commission.',
